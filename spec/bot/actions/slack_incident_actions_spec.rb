...
describe 'actions/slack_incident_actions' do
                     ...
                     response_urls: [
                       {
                         ...
                         channel_id: 'C02FCL06WV6',
                         response_url: 'https://hooks.slack.com/app/T01SF1W8V17/2628129383091/7lENPAMuuPZFD9hTc2ZiICcb',
                       },
                     ] },
    }.with_indifferent_access
  end
  ...
  it 'performs the update action' do
    ...
    SlackIncidentActions.new.update_incident(update_payload)
