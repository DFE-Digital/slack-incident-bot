...
RSpec.describe SlackActionHandler do
  it 'creates the incident channel and populates it correctly' do
    action = JSON.parse(File.read('spec/fixtures/open_incident.json'), symbolize_names: true)
    ...
    SlackActionHandler.new(payload).call
